This folder contains XGBoost model hyperparameters for all baseline 6 models that are created. Apart from it previous versions of hyperparameters are also available.
